...
if(multi_LiDAR_calibration_CONFIG_INCLUDED)
  return()
endif()
set(multi_LiDAR_calibration_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(multi_LiDAR_calibration_SOURCE_PREFIX /home/wxd/calib_gui/calib_ws/src/multi_LIDAR_calibration)
  set(multi_LiDAR_calibration_DEVEL_PREFIX /home/wxd/calib_gui/calib_ws/devel)
  set(multi_LiDAR_calibration_INSTALL_PREFIX "")
  set(multi_LiDAR_calibration_PREFIX ${multi_LiDAR_calibration_DEVEL_PREFIX})
else()
  set(multi_LiDAR_calibration_SOURCE_PREFIX "")
  set(multi_LiDAR_calibration_DEVEL_PREFIX "")
  set(multi_LiDAR_calibration_INSTALL_PREFIX /home/wxd/calib_gui/calib_ws/install)
  set(multi_LiDAR_calibration_PREFIX ${multi_LiDAR_calibration_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'multi_LiDAR_calibration' is deprecated")
...
set(multi_LiDAR_calibration_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/wxd/calib_gui/calib_ws/src/multi_LIDAR_calibration/include;/usr/include/eigen3;/usr/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(multi_LiDAR_calibration_INCLUDE_DIRS "")
  set(_include_dirs "/home/wxd/calib_gui/calib_ws/src/multi_LIDAR_calibration/include;/usr/include/eigen3;/usr/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Jianhong Xu <jianhongxu1006@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${multi_LiDAR_calibration_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'multi_LiDAR_calibration' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'multi_LiDAR_calibration' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wxd/calib_gui/calib_ws/src/multi_LIDAR_calibration/${idir}'.  ${_report}")
    endif()
    _list_append_unique(multi_LiDAR_calibration_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND multi_LiDAR_calibration_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND multi_LiDAR_calibration_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT multi_LiDAR_calibration_NUM_DUMMY_TARGETS)
      set(multi_LiDAR_calibration_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::multi_LiDAR_calibration::wrapped-linker-option${multi_LiDAR_calibration_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR multi_LiDAR_calibration_NUM_DUMMY_TARGETS "${multi_LiDAR_calibration_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::multi_LiDAR_calibration::wrapped-linker-option${multi_LiDAR_calibration_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND multi_LiDAR_calibration_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/wxd/calib_gui/calib_ws/devel/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(multi_LiDAR_calibration_LIBRARY_DIRS ${lib_path})
      list(APPEND multi_LiDAR_calibration_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'multi_LiDAR_calibration'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND multi_LiDAR_calibration_LIBRARIES ${lib})
    endif()
  endif()
...
set(multi_LiDAR_calibration_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${multi_LiDAR_calibration_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 multi_LiDAR_calibration_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${multi_LiDAR_calibration_dep}_FOUND)
      find_package(${multi_LiDAR_calibration_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${multi_LiDAR_calibration_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(multi_LiDAR_calibration_INCLUDE_DIRS ${${multi_LiDAR_calibration_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(multi_LiDAR_calibration_LIBRARIES ${multi_LiDAR_calibration_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${multi_LiDAR_calibration_dep}_LIBRARIES})
  _list_append_deduplicate(multi_LiDAR_calibration_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(multi_LiDAR_calibration_LIBRARIES ${multi_LiDAR_calibration_LIBRARIES})

  _list_append_unique(multi_LiDAR_calibration_LIBRARY_DIRS ${${multi_LiDAR_calibration_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(multi_LiDAR_calibration_EXPORTED_TARGETS ${${multi_LiDAR_calibration_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${multi_LiDAR_calibration_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
